...
- (void)show{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"alreadyShow" object:nil];
}
...
- (void)hide{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"alreadyHidden" object:nil];
}
...
- (CABasicAnimation *)fadeInAnimation{
    self.state = GZHPetalButtonFadeIn;
...
- (CABasicAnimation *)fadeOutAnimation{
    self.state = GZHPetalButtonFadeOut;
    CABasicAnimation *scaleAnimation = [CABasicAnimation animationWithKeyPath:@"transform.scale"];
